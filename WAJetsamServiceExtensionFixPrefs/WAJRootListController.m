#import "WAJRootListController.h"

#import <Preferences/PSSpecifier.h>
#import <UIKit/UIKit.h>

static NSString * const WAJPrefsDomain = @"com.551.wajetsamserviceextensionfix";
static NSString * const WAJRepoURL = @"https://github.com/551UK/WAJetsam-ServiceExtensionFix";

@implementation WAJRootListController
...
- (NSArray *)specifiers {
    ...
    PSSpecifier *enabled = [PSSpecifier preferenceSpecifierNamed:@"Enable Patch"
                                                           ...
                                                           detail:nil
                                                             cell:PSSwitchCell
                                                             edit:nil];
    [enabled setProperty:WAJPrefsDomain forKey:@"defaults"];
...
- (id)readPreferenceValue:(PSSpecifier *)specifier {
    NSString *domain = [specifier propertyForKey:@"defaults"] ?: WAJPrefsDomain;
...
- (void)openRepo {
    NSURL *url = [NSURL URLWithString:WAJRepoURL];
    if (!url) return;
